...
declare module "@salesforce/schema/Opportunity.Entity_Id__c" {
  const Entity_Id__c:string;
  export default Entity_Id__c;
}
declare module "@salesforce/schema/Opportunity.Entity_Type__c" {
  const Entity_Type__c:string;
  export default Entity_Type__c;
}
declare module "@salesforce/schema/Opportunity.City_Id__c" {
