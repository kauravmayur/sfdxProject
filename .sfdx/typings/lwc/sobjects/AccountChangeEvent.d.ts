...
declare module "@salesforce/schema/AccountChangeEvent.UpsellOpportunity_del__c" {
  const UpsellOpportunity_del__c:string;
  export default UpsellOpportunity_del__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Customer_Id_of_2nd_Org__c" {
  const Customer_Id_of_2nd_Org__c:string;
  export default Customer_Id_of_2nd_Org__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Add_Today_Test__c" {
  const Add_Today_Test__c:number;
  export default Add_Today_Test__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Sum_Test_Today__c" {
  const Sum_Test_Today__c:number;
  export default Sum_Test_Today__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Discount__c" {
  const Discount__c:number;
  export default Discount__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Amount__c" {
