...
declare module "@salesforce/schema/OpportunityChangeEvent.Entity_Id__c" {
  const Entity_Id__c:string;
  export default Entity_Id__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Entity_Type__c" {
  const Entity_Type__c:string;
  export default Entity_Type__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.City_Id__c" {
  const City_Id__c:string;
  export default City_Id__c;
}
